...
hi Normal guifg=#dddddd ctermfg=253 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi Comment guifg=#8d8da8 ctermfg=103 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Constant guifg=#569CD6 ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Number guifg=#569cd6 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Identifier guifg=#4fc1ff ctermfg=75 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Structure guifg=#569cd6 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Typedef guifg=#569cd6 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi ColorColumn guifg=NONE ctermfg=NONE guibg=#5f5f7d ctermbg=60 gui=NONE cterm=NONE
hi CursorLineNr guifg=#abb2bf ctermfg=249 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi SignColumn guifg=NONE ctermfg=NONE guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi Conceal guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CursorColumn guifg=NONE ctermfg=NONE guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi CursorLine guifg=NONE ctermfg=NONE guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi Directory guifg=#5fafd7 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=#112134 ctermfg=235 guibg=#608b4e ctermbg=65 gui=NONE cterm=NONE
hi DiffChange guifg=#dcdcaa ctermfg=187 guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi DiffDelete guifg=#112134 ctermfg=235 guibg=#d16969 ctermbg=167 gui=NONE cterm=NONE
hi DiffText guifg=#112134 ctermfg=235 guibg=#dcdcaa ctermbg=187 gui=NONE cterm=NONE
hi ErrorMsg guifg=#f44747 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi VertSplit guifg=#5f5f7d ctermfg=60 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
...
hi LineNr guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi PmenuSel guifg=#112134 ctermfg=235 guibg=#569cd6 ctermbg=74 gui=NONE cterm=NONE
...
hi Terminal guifg=#abb2bf ctermfg=249 guibg=#112134 ctermbg=235 gui=NONE cterm=NONE
hi Visual guifg=NONE ctermfg=NONE guibg=#5c6370 ctermbg=241 gui=NONE cterm=NONE
hi VisualNOS guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WarningMsg guifg=#dcdcaa ctermfg=187 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WildMenu guifg=#112134 ctermfg=235 guibg=#569cd6 ctermbg=74 gui=NONE cterm=NONE
hi EndOfBuffer guifg=#112134 ctermfg=235 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSComment guifg=#8d8da8 ctermfg=103 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSConstant guifg=#569CD6 ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSConditional guifg=#569cd6 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSRepeat guifg=#c586c0 ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSLabel guifg=#c586c0 ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSStructure guifg=#c586c0 ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi CocExplorerBufferExpandIcon guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerBufferNameVisible guifg=#dddddd ctermfg=253 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerBufferBufname guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerBufferModified guifg=#dddddd ctermfg=253 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerBufferBufnr guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerBufferReadonly guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerBufferFullpath guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerIndentLine guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileRoot guifg=#5fafd7 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileRootName guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileExpandIcon guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileFullpath guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi CocExplorerFileLinkTarget guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileHidden guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileClip guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileSize guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileReadonly guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi MatchParenCurguifg=NONE ctermfg=NONE guibg=NONE ctermbg=NONE gui=underline cterm=underline
...
hi NvimTreeIndentMarker guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi NvimTreeSymlink guifg=#29b8d8 ctermfg=38 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi NvimTreeFolderIcon guifg=#5fafd7 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi BufferCurrent guifg=#dddddd ctermfg=253 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi BufferCurrentIndex guifg=#569cd6 ctermfg=74 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi BufferCurrentMod guifg=#dddddd ctermfg=253 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi BufferCurrentSign guifg=#569cd6 ctermfg=74 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi BufferCurrentTarget guifg=#d16969 ctermfg=167 guibg=#202b41 ctermbg=236 gui=bold cterm=bold
hi BufferVisible guifg=#dddddd ctermfg=253 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi BufferVisibleIndex guifg=#dddddd ctermfg=253 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi BufferVisibleMod guifg=#dddddd ctermfg=253 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi BufferVisibleSign guifg=#dddddd ctermfg=253 guibg=#202b41 ctermbg=236 gui=NONE cterm=NONE
hi BufferVisibleTarget guifg=#d16969 ctermfg=167 guibg=#202b41 ctermbg=236 gui=bold cterm=bold
...
hi Normal guifg=#dddddd ctermfg=253 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi Comment guifg=#8d8da8 ctermfg=103 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Cursor guifg=#515052 ctermfg=239 guibg=#aeafad ctermbg=145 gui=NONE cterm=NONE
hi ColorColumn guifg=NONE ctermfg=NONE guibg=#5f5f7d ctermbg=60 gui=NONE cterm=NONE
hi CursorLineNr guifg=#abb2bf ctermfg=249 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi SignColumn guifg=NONE ctermfg=NONE guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi Conceal guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CursorColumn guifg=NONE ctermfg=NONE guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi CursorLine guifg=NONE ctermfg=NONE guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi Directory guifg=#5fafd7 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=#191a21 ctermfg=234 guibg=#608b4e ctermbg=65 gui=NONE cterm=NONE
hi DiffChange guifg=#dcdcaa ctermfg=187 guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi DiffDelete guifg=#191a21 ctermfg=234 guibg=#d16969 ctermbg=167 gui=NONE cterm=NONE
hi DiffText guifg=#191a21 ctermfg=234 guibg=#dcdcaa ctermbg=187 gui=NONE cterm=NONE
hi ErrorMsg guifg=#f44747 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi VertSplit guifg=#5f5f7d ctermfg=60 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi Folded guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi FoldColumn guifg=NONE ctermfg=NONE guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi IncSearch guifg=NONE ctermfg=NONE guibg=#5c6370 ctermbg=241 gui=NONE cterm=NONE
hi LineNr guifg=#5f5f7d ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi NonText guifg=#3b4048 ctermfg=238 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Pmenu guifg=#abb2bf ctermfg=249 guibg=#282c34 ctermbg=236 gui=NONE cterm=NONE
hi PmenuSel guifg=#191a21 ctermfg=234 guibg=#569cd6 ctermbg=74 gui=NONE cterm=NONE
hi PmenuSbar guifg=NONE ctermfg=NONE guibg=#3b4048 ctermbg=238 gui=NONE cterm=NONE
hi PmenuThumb guifg=NONE ctermfg=NONE guibg=#abb2bf ctermbg=249 gui=NONE cterm=NONE
hi Question guifg=#c586c0 ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi QuickFixLine guifg=NONE ctermfg=NONE guibg=#5c6370 ctermbg=241 gui=NONE cterm=NONE
...
hi TabLineSel guifg=#abb2bf ctermfg=249 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TabLineFill guifg=NONE ctermfg=NONE guibg=#252526 ctermbg=235 gui=NONE cterm=NONE
hi Terminal guifg=#abb2bf ctermfg=249 guibg=#191a21 ctermbg=234 gui=NONE cterm=NONE
hi Visual guifg=NONE ctermfg=NONE guibg=#5c6370 ctermbg=241 gui=NONE cterm=NONE
hi VisualNOS guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WarningMsg guifg=#dcdcaa ctermfg=187 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WildMenu guifg=#191a21 ctermfg=234 guibg=#569cd6 ctermbg=74 gui=NONE cterm=NONE
hi EndOfBuffer guifg=#191a21 ctermfg=234 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSComment guifg=#8d8da8 ctermfg=103 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSError guifg=#f44747 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSPunctDelimiter guifg=#abb2bf ctermfg=249 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSPunctBracket guifg=#abb2bf ctermfg=249 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi NvimTreeExecFile guifg=#23d18b ctermfg=42 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi NvimTreeSpecialFile guifg=#dddddd ctermfg=253 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi BufferCurrent guifg=#dddddd ctermfg=253 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi BufferCurrentIndex guifg=#569cd6 ctermfg=74 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi BufferCurrentMod guifg=#dddddd ctermfg=253 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi BufferCurrentSign guifg=#569cd6 ctermfg=74 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi BufferCurrentTarget guifg=#d16969 ctermfg=167 guibg=#282a36 ctermbg=236 gui=bold cterm=bold
hi BufferVisible guifg=#dddddd ctermfg=253 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi BufferVisibleIndex guifg=#dddddd ctermfg=253 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi BufferVisibleMod guifg=#dddddd ctermfg=253 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi BufferVisibleSign guifg=#dddddd ctermfg=253 guibg=#282a36 ctermbg=236 gui=NONE cterm=NONE
hi BufferVisibleTarget guifg=#d16969 ctermfg=167 guibg=#282a36 ctermbg=236 gui=bold cterm=bold
hi BufferInactive guifg=#858585 ctermfg=102 guibg=#2e2e2e ctermbg=236 gui=NONE cterm=NONE
hi BufferInactiveIndex guifg=#858585 ctermfg=102 guibg=#2e2e2e ctermbg=236 gui=NONE cterm=NONE
hi BufferInactiveMod guifg=#858585 ctermfg=102 guibg=#2e2e2e ctermbg=236 gui=NONE cterm=NONE
hi BufferInactiveSign guifg=#858585 ctermfg=102 guibg=#2e2e2e ctermbg=236 gui=NONE cterm=NONE
