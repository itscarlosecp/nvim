...
-- Menu root main menu
-- { menu_name, menu_variable, menu_icon }
...
globalkeys = gears.table.join(
	...
	-- Switch beetween monitor panes with Alt+Tab
	awful.key({ "Mod1" }, "Tab",
		function ()
			awful.client.focus.byidx( 1)
		end,
